      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          <label className="flex items-center gap-2 text-sm text-[var(--oc-muted)]">
            <input type="checkbox" name="targetStaff" defaultChecked className="accent-[var(--oc-accent)]" />
            Ажилтан (байгууллагын дотоод хэрэглэгчид)
          </label>
          <label className="flex items-center gap-2 text-sm text-[var(--oc-muted)]">
            <input type="checkbox" name="targetAccount" defaultChecked className="accent-[var(--oc-accent)]" />
