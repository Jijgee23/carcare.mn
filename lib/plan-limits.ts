...
export const PLAN_LIMIT_CODES = {
  ...
  DAILY_CUSTOMER_NOTIFICATIONS: "daily_customer_notifications",
...
> = {
  ...
  daily_customer_notifications: {
    label: "Өдрийн зар (үйлчлүүлэгчид)",
    description: "Нэг өдөрт үйлчлүүлэгчиддээ илгээх зарын (push broadcast) тоо",
    kind: "COUNT",
    sortOrder: 65,
  },
  max_active_orders: {
    label: "Идэвхтэй засварын хуудас",
    description: "Дуусаагүй (SCHEDULED/IN_PROGRESS) засварын хуудасны тоо",
    kind: "COUNT",
    sortOrder: 70,
  },
...
> = {
  FREE: {
    ...
    daily_customer_notifications: { intValue: 1, boolValue: null },
  ...
  BUSINESS: {
    ...
    daily_customer_notifications: { intValue: 5, boolValue: null },
  ...
  ENTERPRISE: {
    ...
    daily_customer_notifications: { intValue: null, boolValue: null },
